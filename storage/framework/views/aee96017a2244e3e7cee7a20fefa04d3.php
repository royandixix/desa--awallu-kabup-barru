                    ...
                    <div class="p-6 relative">
                        ...
                        <div class="mb-6">
                            <?php if($umkm->deskripsi): ?>
                                <p class="<?php echo e($index % 3 == 0 ? 'text-gray-200' : 'text-gray-700'); ?> text-base leading-relaxed line-clamp-3">
                                    "<?php echo e(Str::limit($umkm->deskripsi, 150)); ?>"
                                </p>
                            <?php else: ?>
                                <p class="<?php echo e($index % 3 == 0 ? 'text-gray-200' : 'text-gray-700'); ?> text-base leading-relaxed">
                        ...
                        <!-- Business Name & Price -->
                        <div class="mb-4">
                            <h3 class="<?php echo e($index % 3 == 0 ? 'text-white' : 'text-gray-900'); ?> text-xl font-bold mb-2">
                                <?php echo e($umkm->nama_usaha); ?>

                            </h3>
                            <?php if(!empty($umkm->harga)): ?>
                                <p class="<?php echo e($index % 3 == 0 ? 'text-green-400' : 'text-green-600'); ?> text-lg font-semibold">
                        ...
                        <!-- Owner Info -->
                        <div class="flex items-center justify-between pt-4 border-t <?php echo e($index % 3 == 0 ? 'border-gray-700' : 'border-gray-200'); ?>">
                            <div class="flex items-center gap-3">
                                ...
                                <?php else: ?>
                                    <div class="w-12 h-12 rounded-full <?php echo e($index % 3 == 0 ? 'bg-gray-700' : 'bg-gray-200'); ?> flex items-center justify-center">
                                        <svg class="w-6 h-6 <?php echo e($index % 3 == 0 ? 'text-gray-400' : 'text-gray-500'); ?>" fill="currentColor" viewBox="0 0 20 20">
                                ...
                                <div>
                                    <p class="<?php echo e($index % 3 == 0 ? 'text-white' : 'text-gray-900'); ?> font-semibold text-sm">
...
</script><?php /**PATH /Users/mac/Documents/desaweb/resources/views/user/page/home/umkm/umkm.blade.php ENDPATH**/ ?>