<?php $__env->startSection('title', 'Pengaduan Masyarakat'); ?>

<?php $__env->startSection('header_berita'); ?>
    <?php echo $__env->make('user.partials.header_pengaduan', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<section class="min-h-screen py-20 bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50">
  <div class="max-w-5xl mx-auto px-6">
        ...
        Swal.fire({
          html: `
            <div style="text-align: center; padding: 1rem;">
              ...
              <p style="font-size: 1.1rem; color: #6b7280; line-height: 1.6;"><?php echo e(session('success')); ?></p>
            </div>
          `,
    ...
    <div>
      ...
      <form id="pengaduanForm" action="<?php echo e(route('user.pengaduan.store')); ?>" method="POST" class="p-8 space-y-6" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="form-group">
            ...
            <input type="text" name="nama" id="nama" value="<?php echo e(old('nama')); ?>" placeholder="Masukkan nama lengkap Anda" class="form-input"/>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="no_hp" id="no_hp" value="<?php echo e(old('no_hp')); ?>" placeholder="Contoh: 08123456789" class="form-input"/>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <select name="kategori" id="kategori" class="form-input">
            ...
            <option value="Kependudukan" <?php echo e(old('kategori') == 'Kependudukan' ? 'selected' : ''); ?>>Kependudukan</option>
        ...
        <div class="form-group">
          ...
          <textarea name="pesan" id="pesan" rows="5" placeholder="Jelaskan pengaduan Anda secara detail..." class="form-input resize-none"><?php echo e(old('pesan')); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('user.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mac/Documents/desaweb/resources/views/user/page/pengaduan/pengaduan.blade.php ENDPATH**/ ?>