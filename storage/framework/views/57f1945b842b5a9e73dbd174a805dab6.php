...
<body class="pt-20">
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-10 flex flex-col items-center text-center">
            ...
            <div class="flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-12 w-full">
                ...
                <div data-aos="zoom-in" class="w-full lg:w-1/3 flex flex-col justify-center items-center">
                    <img src="<?php echo e(asset('img/user/logo/barru.webp')); ?>" alt="Logo Kabupaten Barru"
    ...
    <script>
        ...
        const labels = <?php echo json_encode($data->pluck('kategori'), 15, 512) ?>;
        const values = <?php echo json_encode($data->pluck('jumlah'), 15, 512) ?>;
...
<?php /**PATH /Users/mac/Documents/desaweb/resources/views/user/page/home/administrasipenduduk.blade.php ENDPATH**/ ?>