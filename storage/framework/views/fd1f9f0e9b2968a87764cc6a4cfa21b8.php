...
<div class="container-fluid px-3 px-md-4 py-3 py-md-4">
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <a href="<?php echo e(route('admin.struktur.pkk.create')); ?>" class="btn btn-dark">
                ...
                <table id="pkkTable" class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="<?php echo e(asset('pkk/' . $item->gambar)); ?>" 
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?php echo e(route('admin.struktur.pkk.edit', $item->id)); ?>" 
                                    class="btn btn-dark btn-sm me-1 btn-edit">
                                    <i class="fas fa-edit"></i>
                                </a>

                                
                                <form action="<?php echo e(route('admin.struktur.pkk.destroy', $item->id)); ?>" 
                                      method="POST" 
                                      class="d-inline">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mac/Documents/desaweb/resources/views/admin/page/struktur/pkk/index.blade.php ENDPATH**/ ?>