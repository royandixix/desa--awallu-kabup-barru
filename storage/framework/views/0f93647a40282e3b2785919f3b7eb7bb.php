        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="mini-stat-item d-flex align-items-center p-3 rounded-3 bg-light-hover">
                ...
                <div class="flex-grow-1">
                    ...
                    <h6 class="mb-0 fw-bold fs-6"><?php echo e(number_format($totalPenduduk)); ?></h6>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="mini-stat-item d-flex align-items-center p-3 rounded-3 bg-light-hover">
                ...
                <div class="flex-grow-1">
                    ...
                    <h6 class="mb-0 fw-bold fs-6"><?php echo e(number_format($totalUMKM)); ?></h6>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="mini-stat-item d-flex align-items-center p-3 rounded-3 bg-light-hover">
                ...
                <div class="flex-grow-1">
                    ...
                    <h6 class="mb-0 fw-bold fs-6"><?php echo e(number_format($totalBerita)); ?></h6>
                </div>
            </div>
        </div>
        ...
        <div class="col-12 col-sm-6 col-xl-3">
            <div class="mini-stat-item d-flex align-items-center p-3 rounded-3 bg-light-hover">
                ...
                <div class="flex-grow-1">
                    ...
                    <h6 class="mb-0 fw-bold fs-6"><?php echo e(number_format($pengaduanPending)); ?></h6>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mac/Documents/desaweb/resources/views/admin/page/dashboard/index.blade.php ENDPATH**/ ?>