<header class="top-header">
    <div class="header-left">
        ...
        <div class="header-info">
            <h1 class="header-title"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></h1>
            <ul class="breadcrumb-custom">
                <li><i class="bi bi-house-door"></i></li>
                <li>Admin</li>
                <li class="active"><?php echo $__env->yieldContent('title', 'Dashboard'); ?></li>
            </ul>
        </div>
    </div>
...
</style><?php /**PATH /Users/mac/Documents/desaweb/resources/views/admin/partials/header.blade.php ENDPATH**/ ?>