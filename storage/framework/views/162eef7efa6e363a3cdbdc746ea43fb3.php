...
<nav id="navbar"
    ...
    <div class="w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16 lg:h-20">
            ...
            <!-- LOGO -->
            <a href="<?php echo e(route('user.home')); ?>" class="flex items-center space-x-2 flex-shrink-0 pl-2">
            ...
            <div class="hidden md:flex items-center space-x-2 font-medium text-white text-sm lg:text-base">
                ...
                <div class="relative dropdown-wrapper">
                    ...
                    <div
                        ...
                        <a href="<?php echo e(route('user.transparansi', ['halaman' => 'anggaran'])); ?>"
                            class="block px-4 py-2.5 hover:bg-lime-100 transition rounded-t-xl">Transparansi
                            Anggaran</a>
                        <a href="<?php echo e(route('user.transparansi', ['halaman' => 'laporan'])); ?>"
                            class="block px-4 py-2.5 hover:bg-lime-100 transition">Laporan Kegiatan</a>
                        <a href="<?php echo e(route('user.transparansi', ['halaman' => 'dokumen'])); ?>"
                            class="block px-4 py-2.5 hover:bg-lime-100 transition">Dokumen Perencanaan</a>
                        <a href="<?php echo e(route('user.transparansi', ['halaman' => 'bumdes'])); ?>"
...
</script><?php /**PATH /Users/mac/Documents/desaweb/resources/views/user/partials/navbar.blade.php ENDPATH**/ ?>