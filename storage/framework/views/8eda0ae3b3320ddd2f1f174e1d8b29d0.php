            ...
            <div class="w-full max-w-md relative z-10">
                ...
                <?php if($errors->any()): ?>
                    <div class="mb-6 p-4 bg-red-50 border border-red-200 rounded-lg">
                        <p class="text-sm text-red-800"><?php echo e($errors->first('username')); ?></p>
                    </div>
                <?php endif; ?>
                ...
                <form method="POST" action="<?php echo e(route('login')); ?>" class="space-y-5">
                    ...
                    <div class="mt-4 text-sm text-gray-500">
                        Belum punya akun?
                        <a href="<?php echo e(route('register')); ?>" class="text-green-600 hover:underline">Daftar di sini</a>
                    </div>
                </form>
...
<?php /**PATH /Users/mac/Documents/desaweb/resources/views/auth/login.blade.php ENDPATH**/ ?>