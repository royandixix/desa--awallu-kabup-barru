    ...
    <div class="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-12 items-start">
        ...
        <div class="flex flex-col text-left">
            ...
            <div class="flex items-center gap-4 mb-3">
                <img src="<?php echo e(asset('img/user/logo/barru.webp')); ?>" alt="Logo Barru"
...
<?php /**PATH /Users/mac/Documents/desaweb/resources/views/user/partials/footer.blade.php ENDPATH**/ ?>