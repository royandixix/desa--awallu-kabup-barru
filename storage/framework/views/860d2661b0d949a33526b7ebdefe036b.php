<?php $__env->startSection('title', 'Daftar Kontak & Saran'); ?>
        ...
        <div class="col-md-4">
            <div class="card shadow-sm hover-shadow">
                <div class="card-body">
                    ...
                    <h2 class="fw-bold"><?php echo e($data->total()); ?></h2>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="table-responsive">
                <table id="kontakTable" class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td><?php echo e($i + $data->firstItem()); ?></td>
                            <td><?php echo e($item->nama); ?></td>
                            <td><?php echo e($item->email); ?></td>
                            <td><?php echo e(Str::limit($item->pesan, 50)); ?></td>
                            <td><?php echo e($item->created_at->format('d-m-Y H:i')); ?></td>
                            <td class="text-center">

                                <a href="<?php echo e(route('admin.kontak-saran.show', $item->id)); ?>" 
                                   class="btn btn-dark btn-sm me-1 btn-detail">
                                    <i class="fas fa-eye"></i>
                                </a>

                                <form action="<?php echo e(route('admin.kontak-saran.destroy', $item->id)); ?>" 
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/mac/Documents/desaweb/resources/views/admin/page/kontak_saran/index.blade.php ENDPATH**/ ?>