...
@section('title', 'BPD - Gambar Struktural')
...
<div class="container-fluid px-3 px-md-4 py-3 py-md-4">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <h2 class="fw-bold">{{ $bpds->count() }}</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <a href="{{ route('admin.struktur.bpd.create') }}" class="btn btn-dark">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                {{-- DELETE --}}
                                <form action="{{ route('admin.struktur.bpd.destroy', $bpd->id) }}" 
                                      method="POST" 
                                      class="d-inline">
                                    @csrf
                                    @method('DELETE')
