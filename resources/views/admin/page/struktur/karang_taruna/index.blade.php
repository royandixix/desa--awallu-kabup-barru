...
<div class="container-fluid px-3 px-md-4 py-3 py-md-4">
        ...
        <div class="col-md-4">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <h2 class="fw-bold">{{ $karangTarunas->count() }}</h2>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <a href="{{ route('admin.struktur.karang_taruna.create') }}" class="btn btn-dark">
                ...
                <table id="karangTarunaTable" class="table table-striped table-hover align-middle">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <img src="{{ asset('karang_taruna/' . $item->gambar) }}"
                                     class="rounded"
                            ...
                            <td class="text-center">
                                ...
                                <a href="{{ route('admin.struktur.karang_taruna.edit', $item->id) }}"
                                   class="btn btn-dark btn-sm me-1 btn-edit">
                                    <i class="fas fa-edit"></i>
                                </a>

                                <form action="{{ route('admin.struktur.karang_taruna.destroy', $item->id) }}"
                                      method="POST"
                                      class="d-inline">
                                    @csrf @method('DELETE')
