        ...
        <form id="formEdit" action="{{ route('admin.transparansi.dokumen.update', $dokumen->id) }}" method="POST"
            ...
            <div class="mb-3">
                ...
                <input type="text" id="judul" name="judul"
                    class="form-control @error('judul') is-invalid @enderror" value="{{ old('judul', $dokumen->judul) }}"
                    required>
            ...
            <div class="mb-3">
                ...
                <select id="jenis" name="jenis" class="form-select @error('jenis') is-invalid @enderror" required>
                    ...
                    <option value="PERUBAHAN" {{ old('jenis', $dokumen->jenis) == 'PERUBAHAN' ? 'selected' : '' }}>PERUBAHAN
                    </option>
                </select>
            ...
            <div class="mb-3">
                ...
                <input type="number" id="tahun" name="tahun"
                    class="form-control @error('tahun') is-invalid @enderror" value="{{ old('tahun', $dokumen->tahun) }}"
                    placeholder="YYYY">
            ...
            <div class="mb-3">
                ...
                <small class="text-muted d-block">Jika tidak diganti, biarkan kosong. Maks: 2MB</small>
