    ...
    <form id="formEditUMKM" action="{{ route('admin.home.umkm.update', $umkm->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" id="nama_pengusaha" name="nama_pengusaha" 
                ...
                value="{{ old('nama_pengusaha', $umkm->nama_pengusaha) }}" required>
        ...
        <div class="mb-3">
            ...
            <div class="mt-2">
                <img id="previewPengusaha" src="{{ $umkm->foto_pengusaha ? asset($umkm->foto_pengusaha) : '#' }}" 
                    style="{{ $umkm->foto_pengusaha ? '' : 'display:none;' }}; width:150px; height:100px; object-fit:cover;" 
                    class="img-thumbnail">
            </div>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea id="deskripsi" name="deskripsi" 
                class="form-control @error('deskripsi') is-invalid @enderror" rows="3">{{ old('deskripsi', $umkm->deskripsi) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <textarea id="alamat" name="alamat" 
                class="form-control @error('alamat') is-invalid @enderror" rows="2">{{ old('alamat', $umkm->alamat) }}</textarea>
        ...
        <div class="mb-3">
            ...
            <input type="text" id="harga" name="harga" 
                ...
                value="{{ old('harga', $umkm->harga ? 'Rp '.number_format($umkm->harga,0,',','.') : '') }}" placeholder="Rp 0">
        ...
        <div class="mb-3">
            ...
            <div class="mt-2">
                <img id="previewUMKM" src="{{ $umkm->foto_umkm ? asset($umkm->foto_umkm) : '#' }}" 
                    style="{{ $umkm->foto_umkm ? '' : 'display:none;' }}; width:150px; height:100px; object-fit:cover;" 
                    class="img-thumbnail">
            </div>
        </div>
        ...
        <div id="produkContainer" class="mb-3">
            <h5>Produk UMKM</h5>
            @foreach(old('produk', $umkm->produk->toArray()) as $produk)
            <div class="produk-item mb-3 border p-3 rounded bg-light">
                ...
                <label>Harga</label>
                <input type="text" name="produk[harga][]" class="form-control mb-1" value="{{ isset($produk['harga']) ? 'Rp '.number_format($produk['harga'],0,',','.') : '' }}">
