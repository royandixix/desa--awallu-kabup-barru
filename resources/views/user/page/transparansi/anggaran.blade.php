...
@section('content')
    ...
    <div class="bg-gray-50 py-16 text-[18px]" x-data="{
        ...
        modalPdfUrl: '',
        budgetData: {
            @if ($rekap && $rekap->count()) @foreach ($rekap as $item)
                    '{{ $item->tahun }}': {
                ...
                <div class="space-y-6">
                    @forelse ($anggarans as $item)
                        ...
                        flex flex-col md:flex-row md:items-center md:justify-between transition">
                            ...
                            <div>
                                <h3 class="text-xl font-semibold text-gray-900">{{ $item->judul }} - {{ $item->jenis }}
                                </h3>
                            ...
                            <div class="flex gap-3 mt-4 md:mt-0">
                                <button
                                    @click="previewFile('{{ asset('uploads/transparansi_anggaran/' . $item->file) }}', '{{ $item->judul }} ({{ $item->jenis }})', '{{ $ext }}')"
                                ...
                                <a href="{{ asset('uploads/transparansi_anggaran/' . $item->file) }}" download
