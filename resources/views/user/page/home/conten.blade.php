...
@section('content')
    <section
        class="bg-gradient-to-br from-green-600 to-green-700 min-h-screen flex flex-col justify-center py-14 sm:py-16 md:py-20 overflow-hidden">
            ...
            <div class="flex flex-col lg:flex-row items-start justify-between gap-12 sm:gap-16 lg:gap-24">
                ...
                <div class="w-full lg:w-1/2 flex flex-col items-center lg:items-start fade-left">
                    <div class="relative w-full sm:w-[500px] md:w-[560px] rounded-3xl overflow-hidden shadow-2xl">
                        <img src="{{ asset('img/user/kantor-bupati-barru_169.jpeg') }}" alt="Kantor Bupati Barru"
                ...
                <div class="card first-letter: min-[]: break-before-auto ">
                    <i></i>
                </div>
                <div class="w-full lg:w-1/2 flex justify-center lg:justify-end fade-right">
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8 w-full max-w-[580px]">
                        @foreach ($fitur as $f)
                            <div
                                class="group bg-teal-600 rounded-2xl shadow-lg p-8 text-center transform transition-all duration-300 hover:scale-105 hover:shadow-xl flex flex-col items-center justify-center min-h-[200px]">

                                <div class="flex items-center justify-center mb-4">
                                    <svg class="h-20 w-20 text-white" fill="none" stroke="currentColor" stroke-width="2"
        ...
        <style>
            ...
            .show.fade-left {
                animation: fadeLeft 1.1s ease-out forwards;
            }

            .show.fade-right {
                animation: fadeRight 1.1s ease-out forwards;
            }
        </style>
