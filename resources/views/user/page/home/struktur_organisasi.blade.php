...
<div id="modal" class="hidden fixed inset-0 z-50 items-center justify-center p-4 opacity-0 transition-opacity duration-300">
    ...
    <div id="modalContent" class="relative bg-white rounded-xl max-w-2xl w-full shadow-2xl transform transition-all duration-300 scale-90 opacity-0">
        <button onclick="closeModal()" class="absolute top-3 right-3 bg-red-600 text-white rounded-full w-10 h-10 hover:bg-red-700 text-xl z-10">×</button>
