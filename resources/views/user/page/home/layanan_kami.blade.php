    ...
    <main class="max-w-7xl mx-auto px-6 py-24">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div class="reveal card">
                ...
                <p>SKTM, <span class="text-green-700 font-semibold">Pengantar Nikah</span>, Izin Keramaian, Pengantar
                    BBM, dll.</p>
                <a href="#" class="block mt-5">Read more →</a>
            </div>
            ...
            <div class="reveal card">
                ...
                <p>Pengajuan bantuan seperti <span class="text-green-700 font-semibold">BLT</span> & <span
                        class="text-green-700 font-semibold">PKH</span>.</p>
                <a href="#" class="block mt-5">Read more →</a>
            </div>
            ...
            <div class="reveal card">
                ...
                <p>Layanan pemeriksaan kesehatan gratis dan jadwal posyandu rutin.</p>
                <a href="#" class="block mt-5">Read more →</a>
            </div>
            ...
            <div class="reveal card">
                ...
                <p>Sampaikan aspirasi, saran, atau keluhan secara mudah ke pemerintah desa.</p>
                <a href="#" class="block mt-5">Read more →</a>
            </div>
