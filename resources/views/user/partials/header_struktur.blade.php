...
<section 
    ...
    <div class="relative z-10 text-center px-6 sm:px-10 max-w-3xl" data-aos="fade-up" data-aos-duration="1200">
        <h1 class="text-4xl md:text-6xl font-extrabold tracking-tight text-white mb-4 bg-clip-text text-transparent 
                   bg-gradient-to-r from-lime-300 via-lime-400 to-lime-500 glow-text">
            @switch($halaman)
                @case('pemerintahan_desa') Pemerintah Desa @break
        ...
        <!-- 🔘 Tombol CTA -->
        <a href="#struktur"
           class="inline-block mt-2 px-8 py-3 bg-lime-500 hover:bg-lime-400 text-white font-semibold 
