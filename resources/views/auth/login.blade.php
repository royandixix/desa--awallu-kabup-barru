    ...
    <style>
        ...
        .hero-image {
            background: linear-gradient(135deg, rgba(99, 102, 241, 0.9), rgba(139, 92, 246, 0.9)),
                        url('data:image/svg+xml,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1200 800"><rect fill="%234f46e5" width="1200" height="800"/></svg>');
    ...
    <div class="min-h-screen flex">
            ...
            <div class="w-full max-w-md relative z-10">
                ...
                <div class="mb-10">
                    <div class="flex items-center space-x-3 mb-2">
                        <svg class="w-12 h-12" viewBox="0 0 200 240" xmlns="http://www.w3.org/2000/svg">
                            <path d="M100 10 L180 40 L180 120 Q180 180 100 230 Q20 180 20 120 L20 40 Z" 
                                  fill="#16a34a" stroke="#ca8a04" stroke-width="4"/>
                ...
                <div class="mb-8">
                    ...
                    <p class="text-gray-600 leading-relaxed">
                        Sistem Informasi Desa Lawallu menghubungkan Anda dengan semua layanan administrasi desa, memungkinkan masyarakat untuk mengakses layanan dan mengoptimalkan pertumbuhan desa secara online.
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5">
                    ...
                    <!-- Email Input -->
                    <div>
                        <label for="email" class="block text-sm font-medium text-yellow-600 mb-2">Email</label>
                        <input 
                            type="email" 
                            id="email" 
                            name="email" 
        ...
        <div class="hidden lg:flex lg:w-1/2 hero-image items-center justify-center relative overflow-hidden">
            ...
            <div class="relative z-10 text-center px-12">
                <div class="w-64 h-64 mx-auto mb-8 rounded-full bg-white/10 backdrop-blur-sm flex items-center justify-center">
